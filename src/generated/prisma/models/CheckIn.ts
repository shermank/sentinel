...
export type CheckInWhereInput = {
  ...
  token?: Prisma.StringFilter<"CheckIn"> | string
  status?: Prisma.EnumCheckInStatusFilter<"CheckIn"> | $Enums.CheckInStatus
  sentAt?: Prisma.DateTimeFilter<"CheckIn"> | Date | string
  sentVia?: Prisma.StringNullableListFilter<"CheckIn">
  respondedAt?: Prisma.DateTimeNullableFilter<"CheckIn"> | Date | string | null
  expiresAt?: Prisma.DateTimeFilter<"CheckIn"> | Date | string
...
export type CheckInScalarWhereWithAggregatesInput = {
  ...
  token?: Prisma.StringWithAggregatesFilter<"CheckIn"> | string
  status?: Prisma.EnumCheckInStatusWithAggregatesFilter<"CheckIn"> | $Enums.CheckInStatus
  sentAt?: Prisma.DateTimeWithAggregatesFilter<"CheckIn"> | Date | string
  sentVia?: Prisma.StringNullableListFilter<"CheckIn">
  respondedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"CheckIn"> | Date | string | null
  expiresAt?: Prisma.DateTimeWithAggregatesFilter<"CheckIn"> | Date | string
...
export type CheckInCreateInput = {
  ...
  status?: $Enums.CheckInStatus
  sentAt?: Date | string
  sentVia?: Prisma.CheckInCreatesentViaInput | string[]
...
export type CheckInUpdateInput = {
  ...
  sentVia?: Prisma.CheckInUpdatesentViaInput | string[]
...
export type CheckInCreatesentViaInput = {
  set: string[]
}
...
export type CheckInUpdatesentViaInput = {
  set?: string[]
  push?: string | string[]
}
...
export type CheckInOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "token" | "status" | "sentAt" | "sentVia" | "respondedAt" | "expiresAt" | "createdAt", ExtArgs["result"]["checkIn"]>
...
export interface CheckInFieldRefs {
  ...
  readonly token: Prisma.FieldRef<"CheckIn", 'String'>
  readonly status: Prisma.FieldRef<"CheckIn", 'CheckInStatus'>
  readonly sentAt: Prisma.FieldRef<"CheckIn", 'DateTime'>
  readonly sentVia: Prisma.FieldRef<"CheckIn", 'String[]'>
  readonly respondedAt: Prisma.FieldRef<"CheckIn", 'DateTime'>
